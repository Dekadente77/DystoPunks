  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <b b style={{color: '#E54286'}}>Sold out!</b> You can buy on <a href="https://opensea.io/collection/dystopianpunks" target="_blank" rel="noopener noreferrer"><b>OpenSea</b></a>.
        </p>
      </header>
    </div>
  );
